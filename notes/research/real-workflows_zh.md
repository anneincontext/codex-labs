...
> **回答什么：** 从业者实际怎么用 AI 编程工具（3 次访谈的提炼）。
> **读者前置：** 无；单人细节见 [cases/](../../cases/)。
...
**Lab 对应：** [agents-md_zh.md](../method/agents-md_zh.md) 是项目级；组织级 harness = 分领域的 skills + 评测。完整案例：[004-bigtech-infra](../../cases/004-bigtech-infra/case_zh.md)。
