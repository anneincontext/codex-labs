...
| You want to… | Read |
| ------------ | ---- |
| Get the full picture of openai/codex fast | [codex/architecture.md](codex/architecture.md) · [中文](codex/architecture_zh.md) *(hub — other codex/ notes branch from it)* |
