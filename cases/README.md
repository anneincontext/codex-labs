...
Real session retrospectives — a workflow or skill chain in the wild.

Each case lives in its own folder: `001-short-title/case.md` (+ `case_zh.md`).

Template: [_template/](_template/) — copy the folder and rename.

| Case | Source | Topic |
| ---- | ------ | ----- |
| [001-realtime-ai-presenter](001-realtime-ai-presenter/case.md) | Anne's own demo | prompt → AGENTS.md bootstrap (~20 min demo) |
