...
真实会话复盘——某条 workflow 或技能链在实战中的记录。

每个案例一个文件夹：`001-short-title/case.md`（+ `case_zh.md`）。

模板：[_template/](_template/) — 复制文件夹后改名即可。

| 案例 | 来源 | 主题 |
| ---- | ---- | ---- |
| [001-realtime-ai-presenter](001-realtime-ai-presenter/case_zh.md) | Anne 自己做 demo | prompt → AGENTS.md 启动（约 20 分钟 demo） |
